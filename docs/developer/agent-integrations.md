...
Check existing integration guides in `docs/user-guides/integrations/` (if any) for:
- Tone and style
- Section structure
...
- Check existing guides in `docs/user-guides/integrations/` (if any) for style and structure
